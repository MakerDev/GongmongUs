...
namespace FirstGearGames.Mirrors.Assets.FlexNetworkTransforms
{
    ...
    public class FlexNetworkTransformManager : MonoBehaviour
    {
        ...
        private IEnumerator __SetDataBundleCount()
        {
            ...
            CalculateDataBundleCount(MAXIMUM_PACKET_SIZE, MAXIMUM_PACKET_SIZE);
            ...
            int unreliableSize = Mathf.Min(MAXIMUM_PACKET_SIZE, Transport.activeTransport.GetMaxPacketSize(0));
